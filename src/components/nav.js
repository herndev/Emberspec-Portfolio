    ...
    <nav className="navbar navbar-expand-lg navbar-light sticky-top">
      <div className="container-fluid">
        <NavLink exact to="/" className="link goto-home">
          <i className="ion-home text-white hidden-md"></i>
          <div className="bg-white text-orange crv-8 visible-md">
            <img
          ...
          <div className="navbar-nav w-100">
            <ul className="nav-menu list-unstyled mb-0 list-inline">
              ...
              <li className="list-inline-item m-0">
                <NavLink
                  to="/contact"
                  className="display-centery px-4 nav-item nav-link visible-md pt-2"
                  activeClassName="nav-menu-active"
                >
                  Contact
                </NavLink>
            ...
            <div className="social-menu form-inline ml-auto">
              <ul className="list-unstyled mb-0 list-inline social-icons">
                <li className="list-inline-item">
                  <a
                    ...
                    href="https://facebook.com/dota500"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://twitter.com/herndev"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://instagram.com/hern.dev"
                  >
              ...
              <a
                ...
                target="_"
                className="btn text-white bg-primary-default m-2 font-weight-bold crv-25 px-3"
              >
                Support Us
              </a>
            </div>
